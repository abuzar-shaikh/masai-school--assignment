    ...
    <div id="main-div">
      ...
      <div>
        ...
        <div id="post-followers">
          <div>
            <h3>Posts </h3>
            <p data-testid="user_posts">1841</p>
          </div>
          <div>
            <h3>Followers</h3>
      ...
      <div id="button-div">
        <button onClick={toggle}>{state ? "following" : "follow"}</button>
      </div>
    </div>
  );
}
